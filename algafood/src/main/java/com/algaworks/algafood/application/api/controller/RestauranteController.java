...
import com.algaworks.algafood.application.api.assembler.RestauranteAssembler;
import com.algaworks.algafood.application.api.assembler.RestauranteDisassembler;
...
public class RestauranteController {
    ...
    public ResponseEntity<?> atualizar(@PathVariable UUID id, @RequestBody RestauranteRequest request) {
        try {
            Restaurante restauranteAtual = restauranteService.buscar(new RestauranteId(id));
